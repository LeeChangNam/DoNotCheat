...
package com.example.donotcheat.java;
...
import com.google.mlkit.vision.demo.Exam;
    ...
    try {
      switch (model) {
        ...
        case FACE_DETECTION:
          ...
          cameraSource.setMachineLearningFrameProcessor(new FaceDetectorProcessor(this,preview,graphicOverlay,intent));
          break;
