...
public class FaceDetectorProcessor extends VisionProcessorBase<List<Face>> {
  ...
  private CameraSourcePreview secondPreview;

  private GraphicOverlay secondGraphic;

  public FaceDetectorProcessor(Context context, CameraSourcePreview preview,GraphicOverlay graphicOverlay, Intent intent) {
    super(context);
    ...
    secondIntent=intent;
    secondPreview=preview;
    secondGraphic=graphicOverlay;
  }
  ...
  protected void onSuccess(@NonNull List<Face> faces, @NonNull GraphicOverlay graphicOverlay) {
    for (Face face : faces) {
      graphicOverlay.add(new FaceGraphic(graphicOverlay, face,secondIntent,secondGraphic,secondPreview));
